...
class LoginController extends Controller {
    public function showLoginForm() {
        if (Auth::check()) return redirect()->route($this->redirectRoute());
    ...
    private function redirectRoute(): string {
        ...
        if ($user->hasRole('professeur')) return 'admin.dashboard';
        if ($user->hasRole('etudiant')) return 'admin.dashboard';
        return 'login';
    }
}
